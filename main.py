...
def downloadandconvertplaylist(playlistURL, startingindex=None, endingindex=None, downloadfolder="\\tempDownload\\", conversionfolder="\\MP3s\\", relative=True):
    ...
    for video in videourls:
        if not converter.converttomp3(downloader.downloadvideoaudio(video, downloadfolder, relative)):
            print("First download method failed, attempting second method.")
            converter.converttomp3(downloader.downloadvideoaudio2(video, downloadfolder, relative))
